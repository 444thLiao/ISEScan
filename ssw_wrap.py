...
from ctypes import *
import os
libssw_path = os.path.join(os.path.abspath(os.path.dirname(__file__)),
                                               'libssw.so')
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    ...
    import os
    try:
        libssw = cdll.LoadLibrary(libssw_path)
    except:
    ...
    def align(self, query_seq, min_score=0, min_len=0):
        ...
        if query_len > 30:
            #mask_len = query_len/2 # for python2.x, commented by Zhiqun Xie
            mask_len = int(query_len/2) # for python3.x, modified by Zhiqun Xie
        else:
            mask_len = 15
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    ...
    def _cigar_string(self, cigar, cigar_len, query_len):
        ...
        for i in range(cigar_len):
            ...
            #cigar_string += '{}{}'.format(op_len, op_char)
            cigar_string += '{}{}'.format(op_len, op_char.decode()) # modified by Zhiqun Xie
